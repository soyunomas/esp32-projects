...
These binaries target an **01Space ESP32-C3 0.42 OLED with 4 MB flash** and were
built from the source in this repository with ESP-IDF commit
...
| `wifi-motion-rssi-c3-oled-042.bin` | `0x10000` | Main application |
| `wifi-motion-rssi-c3-oled-042-complete.bin` | `0x0` | Combined factory image |
...
python3 -m esptool --chip esp32c3 --port /dev/ttyACM0 --baud 460800 \
  ...
  0x10000 firmware/wifi-motion-rssi-c3-oled-042.bin
```
