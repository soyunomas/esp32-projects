...
El firmware configura por defecto GPIO0 como botón activo en bajo, con 250 ms
de antirrebote. GPIO0 es el pin BOOT habitual del ESP32-S3: solo se pulsa cuando
