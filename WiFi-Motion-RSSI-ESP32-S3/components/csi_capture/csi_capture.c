...
/*
 * The task keeps a feature extractor and one maximum-sized CSI frame on its
 * stack. csi_feature_extract() also uses a temporary float array. ESP32-S3
 * needs more headroom than the original C3 build once Wi-Fi and floating-point
 * code are active.
 */
