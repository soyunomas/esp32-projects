...
static const char INDEX_HTML[] =
    ...
    ".chart-option{min-width:0;display:flex;align-items:center;gap:4px}.chart-controls label{min-width:0;display:flex;align-items:center;gap:7px;margin:0;cursor:pointer;flex:1}.chart-controls input{padding:0;flex:none}.swatch{width:24px;height:4px;background:#0072b2;flex:none}.swatch.threshold{background:repeating-linear-gradient(90deg,#e69f00 0 7px,transparent 7px 11px)}.swatch.csi{background:repeating-linear-gradient(90deg,#009e73 0 12px,transparent 12px 15px)}.swatch.csi-threshold{background:repeating-linear-gradient(90deg,#cc79a7 0 3px,transparent 3px 7px)}.swatch.hit{background:#d55e00}.swatch.csi-hit{background:repeating-linear-gradient(90deg,#111827 0 6px,transparent 6px 10px)}"
