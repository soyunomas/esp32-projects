...
function uiTog(){
var t=$('batype').value;
$('lbl-target').innerText=(t==='1')?'Topic MQTT':(t==='2')?'URI WebSocket':'URL';
$('btarget').placeholder=(t==='1')?'casa/boton1/estado':(t==='2')?'ws://192.168.1.100/ws':'http://...';
$('div-method').style.display=(t==='0')?'block':'none';
$('div-nocache').style.display=(t==='0')?'block':'none';
var post=($('bmethod').value==='1');
$('div-pl').style.display=(t==='1'||t==='2'||post)?'block':'none';
}
